{
    ...
    "items" : [
	   ...
	   "innovations" :	    [
		"D as head of DP",
		"DP as functional phrase for NP"
	    ],
           "keywords" :		    [
		"Phrase Structure"
	    ],
	...
	{  "type" :                  "entry",
	   ...
	   "innovations" :	    [
		"wh in situ",
		"evidence for covert wh-movement (cf. Huang82)"
	    ],
           "keywords" :		    [
		"Movement",
		"wh-Movement"
	...
	{  "type" :                  "entry",
	   ...
	   "innovations" :	    [
		"First application of Transformational Grammar to German"
	    ],
           "keywords" :		    [
	    ],
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "Transformational",
	   "innovations" :	    [
		"First textbook on Transformational Grammar"
	    ],
           "keywords" :		    [
	    ],
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "GB",
	   "innovations" :	    [
		"UTAH (building on Chomsky 1981), influential theory of incorporation"
	    ],
           "keywords" :		    [
		"Argument Structure",
		"Incorporation",
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "other",
	   "innovations" :	    [
		"First formal study and broad historical survey of command relations and their properties"
	    ],
           "keywords" :		    [
		"Command Relations"
	    ],
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "Transformational",
	   "innovations" :	    [
		"First (unpublished) source of Head Promotion analysis of relative clauses: head undergoes raising from relative clause internal position"
	    ],
           "keywords" :		    [
		"Phrase Structure",
		"Relative Clauses"
	...
	{  "type" :                  "entry",
	   ...
	   "details" :		    "<a href=./syntax_history_bibtex.html#Bresnan70 target=_blank>Details</a>"
	},
	{  "type" :                  "entry",
           "label" :                 "Bresnan 1972",
	   "author" :		    "Bresnan, Joan",
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "Transformational",
	   "innovations" :	    [
		"Revision of A-over-A principle based on Chomsky (1973) that is sensitive to the type of transformations involved rather than categories"
	    ],
           "keywords" :		    [
		"Constraints",
		"Cyclicity",
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "GB",
	   "innovations" :	    [
		"Perlmutter's Unaccusative Hypothesis adopted from Relational Grammar to GB"
	    ],
           "keywords" :		    [
		"Phrase Structure",
		"Argument Structure",
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "Transformational",
	   "innovations" :	    [
		"First mention of A-over-A condition"
	    ],
           "keywords" :		    [
	    ],
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "Transformational",
	   "innovations" :	    [
		"Introduction of Standard Theory (ST)"
	    ],
           "keywords" :		    [
	    ],
	...
	{  "type" :                  "entry",
	   ...
	   "innovations" :	    [
		...
		"Reconstruction",
		"Move wh",
		"away from specific transformations to modular analysis"
	    ],
           "keywords" :		    [
		"wh-Movement",
		"Movement",
	...
	{  "type" :                  "entry",
	   ...
	   "innovations" :	    [
		"Modularity",
		"Representational-Derivational Hybrid",
		"Characterization of A- and A'-bar movement"
	    ],
           "keywords" :		    [
		"Binding",
		"Islands",
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "GB",
	   "innovations" :	    [
		"Analyzes parasitic gaps as empty pronouns, picked up by GPSG and HPSG"
	    ],
           "keywords" :		    [
		"Parasitic Gaps"
	    ],
	...
	{  "type" :                  "entry",
	   ...
	   "innovations" :	    [
		"Barriers",
		"precursor to Minimalist phases",
		"unifiying Government and Movement"
	    ],
           "keywords" :		    [
		"Government",
		"Locality",
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "GB",
	   "innovations" :	    [
		"Generalizes the French and Bambara facts, claiming that objects move to a functional projection for case/agreement called AgrO"
	    ],
           "keywords" :		    [
		"Case",
		"Movement",
	...
	{  "type" :                  "entry",
	   ...
	   "innovations" :	    [
		...
		"no AGR-nodes anymore",
		"does away with Generalized Transformations (replaced by Merge & Move)"
	    ],
           "keywords" :		    [
		"Levels",
		"Locality",
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "Minimalism",
	   "innovations" :	    [
		"Structured Numeration",
		"Agree",
		"does away with feature strength"
	    ],
           "keywords" :		    [
		"Agree",
		"Features",
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "Minimalism",
	   "innovations" :	    [
		"representational phase-level",
		"generalized EPP (OCC-feature)"
	    ],
           "keywords" :		    [
		"Phases",
		"Levels"
	...
	{  "type" :                  "entry",
	   ...
	   "innovations" :	    [
		...
		"that-trace filter",
		"NP-to-VP",
		"coins core grammar and periphery",
		"doubly filled COMP"
	    ],
           "keywords" :		    [
		"Movement",
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "Minimalism",
	   "innovations" :	    [
		"Argues against global economy and transderivational constraints"
	    ],
           "keywords" :		    [
		"Optimality"
	    ],
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "GB",
	   "innovations" :	    [
		"First version of Adjective Hierarchy"
	    ],
           "keywords" :		    [
		"Phrase Structure",
		"Cartography"
	...
	{  "type" :                  "entry",
	   ...
	   "innovations" :	    [
		...
		"early version of head movement"
	    ],
           "keywords" :		    [
		"Locality",
		"Cyclicity",
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "GB",
	   "innovations" :	    [
		"Coins term 'parasitic gaps' independently from Taraldsen 1980"
	    ],
           "keywords" :		    [
		"Parasitic Gaps"
	    ],
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "Minimalism",
	   "innovations" :	    [
		"Derivational reinterpretation of representational notions such as c-command"
	    ],
           "keywords" :		    [
		"Command Relations",
		"Levels",
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "Transformational",
	   "innovations" :	    [
		"Gives the first version of the thematic hierarchy: Agent > Instrument > Object"
	    ],
           "keywords" :		    [
		"Thematic Roles"
	    ],
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "Minimalism",
	   "innovations" :	    [
		"Scope Economy: Covert LF-operations apply only if they are not semantically vacuous"
	    ],
           "keywords" :		    [
		"Logical Form",
		"Quantifiers"
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "Minimalism",
	   "innovations" :	    [
		"Linearization takes place at the phase level, movement from one phase to the next may induce linearization conflicts and hence ungrammaticality"
	    ],
           "keywords" :		    [
		"Linearity",
		"Phases"
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "Minimalism",
	   "innovations" :	    [
		"Index-valued features allow for sharing of features"
	    ],
           "keywords" :		    [
		"Agree",
		"Features"
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "Minimalism",
	   "innovations" :	    [
		"Model of syntax that generates no illformed structures or derivations"
	    ],
           "keywords" :		    [
		"Optimality"
	    ],
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "Transformational",
	   "innovations" :	    [
		"Argument Uniqueness Condition (precursor of Theta-Criterion)"
	    ],
           "keywords" :		    [
		"Thematic Roles",
		"Argument Structure"
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "GPSG",
	   "innovations" :	    [
		"First well-known presentation of GPSG"
	    ],
           "keywords" :		    [
	    ],
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "GB",
	   "innovations" :	    [
		"Conflation of morphology and syntax"
	    ],
           "keywords" :		    [
		"Argument Structure",
		"Incorporation",
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "Transformational",
	   "innovations" :	    [
		"Extension of Leftness Condition"
	    ],
           "keywords" :		    [
		"Crossover",
		"Constraints"
	...
	{  "type" :                  "entry",
	   ...
	   "details" :		    "<a href=./syntax_history_bibtex.html#Holmberg86 target=_blank>Details</a>"
	},
	{  "type" :                  "entry",
           "label" :                 "Hornstein 1998",
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "Minimalism",
	   "innovations" :	    [
		"Movement based analysis of control"
	    ],
           "keywords" :		    [
		"Movement",
		"Control",
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "GB",
	   "innovations" :	    [
		"Evidence for covert movement of wh-words in Chinese",
		"argument-adjunct asymmetries w.r.t. wh-movement"
	    ],
           "keywords" :		    [
		"wh-Movement",
		"Logical Form",
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "Transformational",
	   "innovations" :	    [
		"Elaborated version of X-bar theory"
	    ],
           "keywords" :		    [
		"Phrase Structure"
	    ],
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "Transformational",
	   "innovations" :	    [
		"Application of Transformational to French"
	    ],
           "keywords" :		    [
	    ],
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "GB",
	   "innovations" :	    [
		"claims that participle agreement in clitic, passive, and wh-constructions in French is triggered by leftward movement of the object through the specifier of the participle (cf. little AgrO and vP)"
	    ],
           "keywords" :		    [
		"Case",
		"Movement",
	...
	{  "type" :                  "entry",
	   ...
	   "innovations" :	    [
		...
		"Analysis of possessive and relative clauses"
	    ],
           "keywords" :		    [
		"Phrase Structure",
		"Linearity",
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "Minimalism",
	   "innovations" :	    [
		"Movement based analysis of binding"
	    ],
           "keywords" :		    [
		"Movement",
		"Binding"
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "other",
	   "innovations" :	    [
		"Defines Accessibility Hierarchy for relative clauses: subject > direct object > indirect object > oblique > genitive > object of comparative"
	    ],
           "keywords" :		    [
		"Argument Structure",
		"Relative Clauses",
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "Transformational",
	   "innovations" :	    [
		"First study of Negative Polarity Items",
		"probably first use of command relations in linguistic theory (in-construction-with, essentially the inverse of c-command)"
	    ],
           "keywords" :		    [
		"Command Relations",
		"Polarity"
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "GB",
	   "innovations" :	    [
		"First extensive study of head movement",
		"reduction of locality of movement to ECP"
	    ],
           "keywords" :		    [
		"Head Movement",
		"Movement"
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "GB",
	   "innovations" :	    [
		"Claims that Bambara has NP movement to SpecVP for accusative case"
	    ],
           "keywords" :		    [
		"Case",
		"Movement",
	...
	{  "type" :                  "entry",
	   ...
	   "innovations" :	    [
		"Bijection principle",
		"explicit definition of variable"
	    ],
           "keywords" :		    [
		"Binding",
		"Government",
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "Minimalism",
	   "innovations" :	    [
		"Argues that agents are not arguments of the verb but introduced by a separate head that projects its own phrase --> semantic support for VP-internal Subject Hypothesis and little v"
	    ],
           "keywords" :		    [
		"Logical Form",
		"Phrase Structure"
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "Transformational",
	   "innovations" :	    [
		"Abundance of still quoted binding data"
	    ],
           "keywords" :		    [
		"Binding"
	    ],
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "Transformational",
	   "innovations" :	    [
		"Defines 'command', thus coining the term command relations (see Klima 1964 for first use of command relations under different name)"
	    ],
           "keywords" :		    [
		"Command Relations"
	    ],
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "Transformational",
	   "innovations" :	    [
		"Kommand (k-command): a kommands b iff the minimal cyclic node dominating a also dominates b"
	    ],
           "keywords" :		    [
		"Command Relations"
	    ],
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "Transformational",
	   "innovations" :	    [
		"Empirically oriented application of Transformational Grammar"
	    ],
           "keywords" :		    [
	    ],
	...
	{  "type" :                  "entry",
	   ...
	   "innovations" :	    [
		"Quantifier Raising",
		"distinction between segments and categories"
	    ],
           "keywords" :		    [
		"Quantifiers",
		"Logical Form",
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "Transformational",
	   "innovations" :	    [
		"Perlmutter's conjecture: lack of that-trace filter with pro-drop; first use of output constraints"
	    ],
           "keywords" :		    [
		"pro",
		"A'-Movement",
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "GB",
	   "innovations" :	    [
		"Path containment condition (influenced by Kayne 1983)"
	    ],
           "keywords" :		    [
		"Phrase Structure"
	    ],
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "Minimalism",
	   "innovations" :	    [
		"+/-valued and +/- interpretable",
		"T related to Case (due to Williams)",
		"sharing of feature values"
	    ],
           "keywords" :		    [
		"Agree",
		"Features",
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "GB",
	   "innovations" :	    [
		"LF-movement for long distance reflexives"
	    ],
           "keywords" :		    [
		"Logical Form",
		"Binding",
	   ...
	   "details" :		    "<a href=./syntax_history_bibtex.html#Pica87 target=_blank>Details</a>"
	},
	{  "type" :                  "entry",
           "label" :                 "Pica 1991",
	   "author" :		    "Pica, Pierre",
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "HPSG",
	   "innovations" :	    [
		"Relates binding exclusively to argument structure"
	    ],
           "keywords" :		    [
		"Binding",
		"Argument Structure",
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "Transformational",
	   "innovations" :	    [
		"Unlike Person Constraint (cf. Disjoint Reference Rule)"
	    ],
           "keywords" :		    [
		"Binding"
	    ],
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "Transformational",
	   "innovations" :	    [
		"First discussion of cross-over phenomena"
	    ],
           "keywords" :		    [
		"Crossover",
		"A'-Movement"
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "other",
	   "innovations" :	    [
		"Introduces the concept of Duke-of-York derivations (derivations of positive length with the output of the last step identical to the original input)"
	    ],
           "keywords" :		    [
	    ],
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "GB",
	   "innovations" :	    [
		"Connecting binding theory to argument structure",
		"exempting long-distance reflexives from binding conditions"
	    ],
           "keywords" :		    [
		"Binding",
		"Argument Structure"
	...
	{  "type" :                  "entry",
	   ...
	   "details" :		    "<a href=./syntax_history_bibtex.html#ReinhartReuland93 target=_blank>Details</a>"
	},
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "Minimalism",
	   "innovations" :	    [
		"Binding of anaphors as Spec-Head feature copying"
	    ],
           "keywords" :		    [
		"Binding",
		"Features"
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "Transformational",
	   "innovations" :	    [
		"S' (= CP) a bounding node in Italian"
	    ],
           "keywords" :		    [
		"wh-Movement",
		"A'-Movement",
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "Transformational",
	   "innovations" :	    [
		"Difference between raising and control",
		"Equi-NP Deletion",
		"Extraposition",
		"distinction between unbounded, bi- and monocyclic transformations"
	    ],
           "keywords" :		    [
		"Control",
		"Raising",
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "Minimalism",
	   "innovations" :	    [
		"Most elaborated version of the Adjective Hierarchy"
	    ],
           "keywords" :		    [
		"Phrase Structure",
		"Cartography"
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "Transformational",
	   "innovations" :	    [
		"First published version of the Head Promotion analysis of relative clauses (cf. Brame 1968)"
	    ],
           "keywords" :		    [
		"Phrase Structure",
		"Relative Clauses"
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "GB",
	   "innovations" :	    [
		"Quantifier floating as quantifier stranding"
	    ],
           "keywords" :		    [
		"Quantifiers",
		"Movement"
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "Minimalism",
	   "innovations" :	    [
		"First discussion of instances where interpretable features are not interpreted at LF"
	    ],
           "keywords" :		    [
		"Features",
		"Logical Form"
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "Transformational",
	   "innovations" :	    [
		"Modern version of Small Clause analysis (cf. Williams 1975)"
	    ],
           "keywords" :		    [
		"Phrase Structure"
	    ],
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "GB",
	   "innovations" :	    [
		"Projection rules instead of rewrite rules subject to X-bar-theory",
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "GB",
	   "innovations" :	    [
		"DP hypothesis: determiners are phrases with NPs as their complement"
	    ],
           "keywords" :		    [
		"Phrase Structure"
	    ],
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "Minimalism",
	   "innovations" :	    [
		"Propose MaxElide as a transderivational principle for ellipsis resolution"
	    ],
           "keywords" :		    [
		"Logical Form",
		"Ellipsis"
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "GB",
	   "innovations" :	    [
		"Formulates Taraldsen's Generalization: Overt agreement morphology licenses null subjects"
	    ],
           "keywords" :		    [
		"Agreement",
		"pro"
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "GB",
	   "innovations" :	    [
		"First coinage of term 'parasitic gaps'"
	    ],
           "keywords" :		    [
		"Parasitic Gaps"
	    ],
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "GB",
	   "innovations" :	    [
		"Formulates the head movement constraint",
		"directionality of Case and theta role assignment"
	    ],
           "keywords" :		    [
		"Case",
		"Constraints",
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "Minimalism",
	   "innovations" :	    [
		"Using multiple feature-checking in empirical analysis"
	    ],
           "keywords" :		    [
		"Features"
	    ],
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "Minimalism",
           "innovations" :	    [
		"command units",
		"multiple Spell-Outs per derivation"
	    ],
	   "keywords" :		    [
		"Phases"
	    ],
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "Transformational",
	   "innovations" :	    [
		"Beginnings of Case theory as a reaction to Chomsky & Lasnik 1977",
		"Case filter (towards modularity)"
	    ],
           "keywords" :		    [
		"Case"
	    ],
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "Transformational",
	   "innovations" :	    [
		"Distinction between weak and strong crossover"
	    ],
           "keywords" :		    [
		"Crossover"
	    ],
	   "details" :		    "<a href=./syntax_history_bibtex.html#Wasow72 target=_blank>Details</a>"
	},
	{  "type" :                  "entry",
           "label" :                 "Wasow 1979",
	   "author" :		    "Wasow, Thomas",
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "Transformational",
	   "innovations" :	    [
		"Introduces the 'Williams Cycle' (inofficial term): Movement from A to B is possible only if B would be at a higher position than A in a normal clause"
	    ],
           "keywords" :		    [
		"Constraints",
		"Cyclicity",
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "Transformational",
	   "innovations" :	    [
		"Small Clauses (note that Williams' SCs aren't directly related to the canoncial SCs)"
	    ],
           "keywords" :		    [
		"Phrase Structure"
	    ],
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "Transformational",
	   "innovations" :	    [
		"First mention of Across-the-board movement"
	    ],
           "keywords" :		    [
		"Ellipsis",
		"Movement"
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "Transformational",
	   "innovations" :	    [
		"First detailled version of Across-the-board movement"
	    ],
           "keywords" :		    [
		"Ellipsis",
		"Movement"
	...
	{  "type" :                  "entry",
	   ...
	   "framework" :             "GB",
	   "innovations" :	    [
		"Evidence against small clause analysis"
	    ],
           "keywords" :		    [
		"Phrase Structure"
	    ],
